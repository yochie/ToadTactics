...
public readonly struct CharacterStats : IEquatable<CharacterStats>
{
    ...
    public readonly int stealthLayers;
                          ...
                          int stealthLayers = 0)
    {
        ...
        this.stealthLayers = stealthLayers;
    }
                      ...
                      int? stealthLayers = null)
    {
        ...
        this.stealthLayers = stealthLayers == null ? toCopy.stealthLayers : stealthLayers.GetValueOrDefault();
    }
    ...
    public bool Equals(CharacterStats other)
    {
        ...
        if (this.maxHealth == other.maxHealth &&
            ...
            this.stealthLayers == other.stealthLayers
            )
        {
